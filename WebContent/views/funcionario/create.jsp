				...
				<header class="page-header">
					...
					<h1 class="page-title">
						...
						<small class="pull-right"> <a class="btn btn-primary"
							href="${linkListaFunc}">Listar Funcionarios</a>
						</small>
					</h1>
					...
					<div class="col-md-12">
						<form action="${linkNovo}" method="post">
							...
							<fieldset class="form-group">
								...
								<div class="row">
									<div class="col-sm-6">
										<cF:cFormBasic id="login" valor="${func.login}"
											rotulo="Usuário" type="text" classe="form-control"
											outro="required" />
									</div>
							...
							<fieldset class="form-group">
								...
								<div class="row">
									<div class="col-sm-4">
										<cF:cSelectSouN id="ativo" valor="${func.ativo=='s'?'s':'n'}"
											rotulo="Status do Usuário" classe="form-control" />
									</div>
									<div class="col-sm-4">
