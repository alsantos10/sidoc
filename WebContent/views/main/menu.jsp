    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav pull-right">
                ...
                <c:if test="${not empty usuarioLogado}">
                    <c:url value="/sistema?c=Funcionario&acao=editar&id=${usuarioLogado.id}" var="menuDados" />
                    <c:url value="/sistema?c=Funcionario&acao=senha&id=${usuarioLogado.id}"  var="menuSenha" />
                    <li class="dropdown"><a href="#" class="btn dropdown-toggle" data-toggle="dropdown">Ferramentas <b class="caret"></b></a>
