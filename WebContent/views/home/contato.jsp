            ...
            <div class="row">
                ...
                <article class="col-sm-9 maincontent">
                    ...
                    <form action="${linkNovo}" method="post">
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <cF:cFormBasic id="email" valor="${email}" rotulo="E-mail"
                                               type="email" classe="form-control" outro="required" />
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <textarea placeholder="Escreva sua mensagem aqui..." name="comentario" 
                        ...
                        <div class="row">
                            <div class="col-lg-6 text-right">
                                <input class="btn btn-action" type="submit" id="sendmail"
